...
# USB driver for BOSS Katana amplifiers
cask "santerj/boss-katana/katana-driver"
# Visual editor for BOSS Katana (Mk1) amplifiers
cask "santerj/boss-katana/katana-tone-studio-mk1"
